...
char *request_msg(char msg[BUFSIZE])
{
	
}


int branch(char msg[BUFSIZE])
{
	scanf("%*c");
	printf("\n\
1. 리스트 상태 보기\n\
...
int init_sock(int *serv_sock,int *clnt_sock)
{
}
...
int main() //
{
	...
	int serv_sock,str_len,clnt_addr_size;
